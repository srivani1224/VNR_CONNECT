...
class CreativeArtsOptionsDisplay extends StatefulWidget {
  const CreativeArtsOptionsDisplay({super.key});

  @override
  CreativeArtsOptionsDisplayState createState() =>
      CreativeArtsOptionsDisplayState();
}

class CreativeArtsOptionsDisplayState
    extends State<CreativeArtsOptionsDisplay> {
  @override
